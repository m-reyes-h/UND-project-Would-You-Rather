...
class NewUserForm extends Component {
  ...
  handleSubmit = event => {
    ...
    this.props.onSubmit(firstName, lastName, avatarURL);
  };
      ...
      <div className="newu-content mt-4 text-center">
        ...
        >
          ...
          <div className="p-4 px-5">
            ...
            <h5 className="login-subtitle mt-5 mb-4">Select your avatar</h5>
        ...
        <Link to="/" className="d-inline-block text-uppercase mt-5">
          <svg
            className="mr-2"
